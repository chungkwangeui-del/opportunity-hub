...
const FAQ = [
  {
    ...
    a: "Our AI scraper runs daily at 9am EST, collecting new opportunities from over 15 sources including NSF, DOE, Nature Careers, Indeed, and university department pages.",
  },
  {
  ...
  },
  {
    ...
    a: "We scrape NSF REU, DOE SULI, Pathways to Science, DAAD RISE, Amgen Scholars, Indeed, Glassdoor, Nature Careers, EURAXESS, and major university chemistry/STEM department pages.",
  },
  {
    ...
    <div className="mx-auto max-w-3xl px-6 py-16">
      ...
      <div className="mt-12 rounded-xl border border-gray-200 bg-white p-8">
        ...
        <ul className="space-y-1 text-sm text-gray-600">
          ...
          <li><strong>Frontend:</strong> Next.js 15 + Tailwind CSS</li>
