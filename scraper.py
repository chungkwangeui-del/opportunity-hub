...
CURATED_PROGRAMS: list[dict] = [
    ...
    {"organization": "HHMI", "title": "Gilliam Fellows Program", "url": "https://www.hhmi.org/programs/gilliam-fellows", "field": "Biology", "opportunity_type": "Fellowship", "year_level": ["Graduate"], "country": "USA", "state": None, "city": None, "is_paid": True, "compensation": "Up to $159,000 over 3 years", "description": "Supports PhD students from underrepresented backgrounds in biomedical sciences. Full dissertation support plus postdoc funding."},
    ...
    {"organization": "Janelia Research Campus (HHMI)", "title": "Summer Undergraduate Research Program (Cech Fellows)", "url": "https://www.janelia.org/you-janelia/students-and-postdocs/janelia-summer-undergraduate-research-program", "field": "Neuroscience", "opportunity_type": "Research", "year_level": ["Junior", "Senior"], "country": "USA", "state": "VA", "city": "Ashburn", "is_paid": True, "compensation": "Stipend + housing + travel", "description": "9-week summer research at HHMI's Janelia campus. ~20 fellows work in small labs on neuroscience, imaging, and computational biology."},
    {"organization": "Georgia Tech", "title": "REU – Institute for Matter and Systems", "url": "https://matter-systems.gatech.edu/undergraduate-research", "field": "Materials Science", "opportunity_type": "Research", "year_level": ["Sophomore", "Junior"], "country": "USA", "state": "GA", "city": "Atlanta", "is_paid": True, "compensation": "Stipend + housing", "description": "NSF-funded REU in nanoscale science and engineering at Georgia Tech. Includes science communication and entrepreneurship."},
    {"organization": "Brookhaven National Laboratory", "title": "Undergraduate Internship Programs", "url": "https://www.bnl.gov/education/college-students.php", "field": "Physics", "opportunity_type": "Internship", "year_level": ["Sophomore", "Junior", "Senior"], "country": "USA", "state": "NY", "city": "Upton", "is_paid": True, "compensation": "Stipend + housing", "description": "Summer research at Brookhaven National Lab in physics, chemistry, biology, engineering, and computing. 350+ students per year."},
    ...
    {"organization": "Astronaut Scholarship Foundation", "title": "Astronaut Scholarship", "url": "https://astronautscholarship.org/scholarshipprogram.html", "field": "General STEM", "opportunity_type": "Scholarship", "year_level": ["Junior", "Senior"], "country": "USA", "state": None, "city": None, "is_paid": True, "compensation": "$15,000", "description": "For outstanding STEM students who show initiative, creativity, and excellence in research. 70+ scholarships per year."},
    ...
    {"organization": "KIST", "title": "KIST School Student Internship Program", "url": "https://www.kist.re.kr/kist_school_eng/StudentTrainingProgram.do", "field": "General STEM", "opportunity_type": "Internship", "year_level": ["Junior", "Senior", "Graduate"], "country": "South Korea", "state": None, "city": "Seoul", "is_paid": True, "compensation": "1.2-1.4M KRW/month + dormitory", "description": "6-month research internship at Korea Institute of Science and Technology. AI, robotics, nanoscience, energy, biomedical."},
    ...
    # ── Competitions ──────────────────────────────────────────────────
    {"organization": "iGEM Foundation", "title": "iGEM Competition", "url": "https://competition.igem.org/participation/rules-and-policies", "field": "Biology", "opportunity_type": "Competition", "year_level": ["Freshman", "Sophomore", "Junior", "Senior", "Graduate"], "country": "USA", "state": None, "city": None, "is_paid": False, "compensation": None, "description": "International synthetic biology competition. Teams design and build biological systems. Jamboree held annually."},
